...
func Set(app *fiber.App) {
	...
	app.Get("/saved-tiles/:layer/:z/:x/:y.pbf", agentMW.IsLoggedIn(), tiles.SaveVectorTileHandler)
	app.Get("/saved-tiles/public/:layer/:z/:x/:y.pbf", tiles.SaveVectorTileHandler)
